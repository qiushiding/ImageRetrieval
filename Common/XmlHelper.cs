...
namespace Common
{
    public class XmlHelper
    {
        ...
        /// <summary>
        /// 选择匹配XPath表达式的节点的子节点列表.
        /// </summary>
        /// <param name="xmlFileName">XML文档完全文件名(包含物理路径)</param>
        /// <param name="xpath">要匹配的XPath表达式(例如:"//节点名//子节点名")</param>
        /// <returns>返回子节点列表XmlNodeList</returns>
        public static XmlNodeList GetChileNodesByXpath(string xmlFileName, string xpath)
        {
            XmlDocument xmlDoc = new XmlDocument();
            try
            {
        ...
        public static string GetNodesContentByXpath(string xmlString, string xpath)
        {
